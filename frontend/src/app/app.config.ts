...
export const appConfig: ApplicationConfig = {
  providers: [
    ...
    provideHttpClient(),
    provideStore({ user: UserReducer, event:EventReducer, group: GroupReducer, friendship: FriendshipReducer }),
    provideEffects([UserEffects, EventEffects, GroupEffects, FriendshipEffects]),
    provideAnimations()
  ],
};
